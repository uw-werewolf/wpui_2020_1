...
\begin{frame}
  ...
  % 20% reduction
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_no_shutdowns_CC_r1.png}
  % 40% reduction
...
\item Onshore wind ramps up. \\
  ...
  % 20% reduction
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_no_shutdowns_wind_r1.png}
  % 40% reduction
...
\begin{frame}
  ...
  % 20% reduction
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_shutdowns_CT_r1.png}
  % 40% reduction
...
\item Onshore wind ramps up.\\
  ...
  % 20% reduction
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_shutdowns_wind_r1.png}
  % 40% reduction
