...
% carbon reductions (0-40%) under a no leakage scenario come from shutting down coal steam plants and expand in combined cycle (nat gas) plants

% carbon reductions (40-80%) come from a reduction in generation from those combined cycle plants and expansion in wind (and little bit of solar)
...
\end{frame}
  ...
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_CC_r3_built_cap.png}
  %
  % % this is where wind is built under at 60% carbon emissions reductions
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_wind_r4_built_cap.png}
  %
  % % this is where wind is built under at 80% carbon emissions reductions
  % \includegraphics[width=0.2\textwidth]{includes/no_leakage_wind_r5_built_cap.png}
...
% the story here is that even modest increases in demand (5%) lead to big changes.  new demand is met with expansion in nat-gas technologies (combustion turbine and combine cycle plants)

% also pushes WI into a net exporter of energy
...
% this shows the impact on power flows through the network (no leakage assumption)
\includegraphics[width=0.20\textwidth]{includes/demand_agg_exim.png}

% shows generation portfolio in WI
\includegraphics[width=0.20\textwidth]{includes/demand_agg_generation_cntlreg.png}
